  ...
  return (
    <div className="fixed inset-0 z-50 w-screen h-screen bg-[#FCFCFA] overflow-hidden">
      ...
      <button
        ...
        className="absolute top-6 right-6 z-50 text-slate-600 hover:text-[#111827] bg-slate-100 hover:bg-slate-200 transition flex items-center gap-1.5 text-xs font-bold px-4 py-2 rounded-full border border-[#EADBD0] shadow-md cursor-pointer"
      >
        <X className="w-4 h-4" />
        <span>Close</span>
      </button>
